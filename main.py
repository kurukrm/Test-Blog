...
def register():
    ...
    return render_template("register.html", form_reg=form, current_user=current_user)
...
def login():
    ...
    return render_template("login.html", form_log=form, current_user=current_user)
